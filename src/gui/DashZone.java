    ...
    private void initGUI() {
        try {
                ...
                jButton1.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        if (evt.getSource() == jButton1) {
                            ...
                            Application.getInstancia().changeTicketState(state, Integer.parseInt(combo_reclamos.getSelectedItem().toString().substring(0, 2).trim()));
                            Application.getInstancia().addLog(tratamientoText.getText(), Integer.parseInt(combo_reclamos.getSelectedItem().toString().substring(0, 2).trim()));
                        }
                    }
...

            {
                ...
                jRadioButton1.setText("rechazado");
