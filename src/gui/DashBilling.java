...
public class DashBilling extends ObserverReclamo {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				DashBilling inst = new DashBilling();
	...
	private void initGUI() {
		try {
			...
			}
			{
				...
				area_notificaiones.setBounds(10, 11, 421, 71);
	...
	* is not needed in any other situation.
	...
	public static Object getGUIBuilderInstance() {
		return new DashBilling(Boolean.FALSE);
	}
	 ...
	 */
	public DashBilling(Boolean initGUI) {
		super();
	}
